...
public abstract class PacketDispatcher {
     ...
     * @param messageClass
     */
    protected final <REQ extends IMessage, REPLY extends IMessage> void registerMessage(
     ...
     */
    public final void sendToAllAround(IMessage pMessage, int pDimension, double pX, double pY, double pZ,
            double pRange) {
    ...
    public final void sendToAllAround(IMessage pMessage, EntityPlayer pPlayer, double pRange) {
        sendToAllAround(
                pMessage,
                pPlayer.worldObj.provider.dimensionId,
                pPlayer.posX,
                pPlayer.posY,
                pPlayer.posZ,
                pRange);
    ...
    /**
     * Send this message to everyone connected to the server. See {@link SimpleNetworkWrapper#sendToAll(IMessage)}
     */
