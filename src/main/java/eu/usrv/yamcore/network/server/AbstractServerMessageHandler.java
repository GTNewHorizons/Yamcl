...
package eu.usrv.yamcore.network.server;
...
/**
 * 
 * This is just a convenience class that will prevent the client-side message handling method from appearing in our
