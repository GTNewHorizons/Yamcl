...
public class ItemDescriptor
{
   ...
   * @return Constructed ItemDescriptor. Will NOT return null if the ItemIdentifier cannot be found
   * in the Game-registry! Make sure to validate the item before using it
   */
   ...
   * actual Item registered with Forge's GameRegistry. Note: Depending on where you are constructing an instance
   * if ItemDescriptor, you may want to set this to FALSE. This is most likely the case if you are using the
   * ItemDescriptor class in either PreInit(), Init() or PostInit() in your mod
   * @return Constructed ItemDescriptor. If pVerifyItemExists is TRUE, it will return NULL if the Identifier cannot
   * be found in the GameRegistry
   */
