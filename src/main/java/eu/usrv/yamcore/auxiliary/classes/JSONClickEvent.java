...
public class JSONClickEvent {
    ...
    /**
     * Will suggest a command. This will open chat, place your command but it will wait for the player to hit return to
     * send it
     * 
     * @param pCommand
     * @return
    ...
    /**
     * Will open the provided URL. use this to create short links The player has to accept to open the URL via a popup,
     * just like clicking a regular link
     * 
