...
public final class LogHelper {
    ...
    /**
     * Print a log just one time per run. The category will not be displayed, it is only used to track all messages Use
     * FullQualified names to differ them, like classname.function.error_no_2
     * 
    ...
    public void DumpStack(Exception e) {
        if (e.getMessage() != null) FMLLog.severe(e.getMessage(), new Object[0]);
        else FMLLog.severe(e.getStackTrace().toString(), new Object[0]);
    }
