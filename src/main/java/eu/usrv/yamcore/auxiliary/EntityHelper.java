...
public class EntityHelper {
     ...
     * @param pDamageToDeal
     */
    public static void DealDamageToEntitiesInRange(EntityPlayer pEntityPlayer, int pRange, Class pTargetEntityClass,
            int pDamageToDeal) {
        ...
        try {
            ...
            AxisAlignedBB tBoundingBox = AxisAlignedBB
                    .getBoundingBox(x - pRange, y - pRange, z - pRange, x + pRange + 1, y + pRange + 1, z + pRange + 1);
            ...
            YAMCore.instance.getLogger().error(
                    "EntityHelper.DealDamageToEntitiesInRange.Error",
                    "Error while processing DealDamageToEntitiesInRange");
