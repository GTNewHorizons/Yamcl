 ...
 *
 * @param <T> Either Container, or a type that extends it; use something specific if you want tighter integration
 *            between your GUI elements and the container
...
public abstract class DynGUIContainer<T extends Container> extends GuiContainer {
    ...
    public void initGui() {
        ...
        elements.addAll(
                ((ArrayList<Slot>) container.inventorySlots).stream().map(slot -> new SlotElement(slot, skin))
