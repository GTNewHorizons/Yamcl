...
public class SimpleRectangleBackground extends GUIBackgroundProvider {
    ...
    protected void addComponents() {
        ...
        components.add(
                new SimpleDrawingElement(BackgroundConfig.FILLER.getConfig(tex).setWH(width - 5, height - 5))
                        .setXY(2, 2));

        components.add(
                new SimpleDrawingElement(BackgroundConfig.SIDE_TOP.getConfig(tex).setWH(width - 5, 3)).setXY(2, 0));
        components.add(
                new SimpleDrawingElement(BackgroundConfig.SIDE_BOTTOM.getConfig(tex).setWH(width - 5, 3))
                        .setXY(2, height - 3));
        components.add(
                new SimpleDrawingElement(BackgroundConfig.SIDE_LEFT.getConfig(tex).setWH(3, height - 5)).setXY(0, 2));
        components.add(
                new SimpleDrawingElement(BackgroundConfig.SIDE_RIGHT.getConfig(tex).setWH(3, height - 4))
                        .setXY(width - 3, 2));

        components
                .add(new SimpleDrawingElement(BackgroundConfig.CORNER_TOP_LEFT.getConfig(tex).setWH(3, 3)).setXY(0, 0));
        components.add(
                new SimpleDrawingElement(BackgroundConfig.CORNER_TOP_RIGHT.getConfig(tex).setWH(4, 4))
                        .setXY(width - 4, 0));
        components.add(
                new SimpleDrawingElement(BackgroundConfig.CORNER_BOTTOM_LEFT.getConfig(tex).setWH(3, 3))
                        .setXY(0, height - 3));
        components.add(
                new SimpleDrawingElement(BackgroundConfig.CORNER_BOTTOM_RIGHT.getConfig(tex).setWH(4, 4))
